const colors = ['#ff00ff', '#ff00e6', '#ff00cc', '#ff00b2', '#ff0099',
                '#ff0080', '#ff0066', '#ff004c', '#ff0033', '#ff001a',   // +8-=-=-=-=-=-8+
                '#ff0000', '#ff1a00', '#ff3300', '#ff4c00', '#ff6600',   //  | ,.-'"'-., |
                '#ff8000', '#ff9900', '#ffb200', '#ffcc00', '#ffe600',   //  |/         \|
                '#ffff00', '#e6ff00', '#ccff00', '#b2ff00', '#99ff00',   //  |\:.     .:/|
                '#80ff00', '#66ff00', '#4cff00', '#33ff00', '#1aff00',   //  | \:::::::/ |
                '#00ff00', '#00ff1a', '#00ff33', '#00ff4c', '#00ff66',   //  |  \:::::/  |
                '#00ff80', '#00ff99', '#00ffb2', '#00ffcc', '#00ffe6',   //  |   \:::/   |
                '#00ffff', '#00e6ff', '#00ccff', '#00b2ff', '#0099ff',   //  |    ):(    |
                '#0080ff', '#0066ff', '#004cff', '#0033ff', '#001aff',   //  |   / . \   |
                '#0000ff', '#0909fb', '#1212f7', '#1a1af3', '#2323ef',   //  |  /  .  \  |
                '#2c2ceb', '#3535e7', '#3e3ee3', '#4646df', '#4f4fdb',   //  | /   .   \ |
                '#5858d8', '#6161d4', '#6a6ad0', '#7272cc', '#7b7bc8',   //  |/   .:.   \|
                '#8484c4', '#8d8dc0', '#9696bc', '#9e9eb8', '#a7a7b4',   //  |\.:::::::./|
                '#b0b0b0', '#a7a7a7', '#9f9f9f', '#969696', '#8d8d8d',   //  | '~-___-~' |
                '#848484', '#7c7c7c', '#737373', '#6a6a6a', '#616161',   // +8-=-=-=-=-=-8+
                '#595959', '#505050', ];
